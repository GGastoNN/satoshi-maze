...
const BRAND_STRINGS := {
	"en": {
		...
		"CANCELAR": "CANCEL",
		"SALIR": "EXIT",
		"Los niveles normales son gratis. Solo los Boss Maze requieren pago y la campaña debe completarse estrictamente en orden.": "Normal levels are free. Only Boss Mazes require payment, and the campaign must be completed strictly in order.",
		"PROGRESO SECUENCIAL": "SEQUENTIAL PROGRESS",
		"COMPLETADO": "COMPLETED",
		"DISPONIBLE": "AVAILABLE",
		"EN SECUENCIA": "IN SEQUENCE",
		"Acceso permanente a este Boss Maze. Debés llegar completando la campaña en orden.": "Permanent access to this Boss Maze. You must reach it by completing the campaign in order.",
		"CAMPAÑA SECUENCIAL": "SEQUENTIAL CAMPAIGN",
		"Los niveles normales son gratis. Debés completar cada nivel en orden; solo los Boss Maze requieren pago.": "Normal levels are free. You must complete every level in order; only Boss Mazes require payment.",
		"Los pagos compran acceso a Boss Maze y cosméticos permanentes. No venden soluciones ni ventajas competitivas.": "Payments buy Boss Maze access and permanent cosmetics. They never sell solutions or competitive advantages.",
	},
	"pt": {
		...
		"CANCELAR": "CANCELAR",
		"SALIR": "SAIR",
		"Los niveles normales son gratis. Solo los Boss Maze requieren pago y la campaña debe completarse estrictamente en orden.": "Os níveis normais são grátis. Apenas os Boss Maze exigem pagamento, e a campanha deve ser concluída estritamente em ordem.",
		"PROGRESO SECUENCIAL": "PROGRESSO SEQUENCIAL",
		"COMPLETADO": "CONCLUÍDO",
		"DISPONIBLE": "DISPONÍVEL",
		"EN SECUENCIA": "EM SEQUÊNCIA",
		"Acceso permanente a este Boss Maze. Debés llegar completando la campaña en orden.": "Acesso permanente a este Boss Maze. Você precisa chegar até ele completando a campanha em ordem.",
		"CAMPAÑA SECUENCIAL": "CAMPANHA SEQUENCIAL",
		"Los niveles normales son gratis. Debés completar cada nivel en orden; solo los Boss Maze requieren pago.": "Os níveis normais são grátis. Você deve concluir cada nível em ordem; apenas os Boss Maze exigem pagamento.",
		"Los pagos compran acceso a Boss Maze y cosméticos permanentes. No venden soluciones ni ventajas competitivas.": "Os pagamentos compram acesso aos Boss Maze e cosméticos permanentes. Não vendem soluções nem vantagens competitivas.",
	},
	"fr": {
		...
		"CANCELAR": "ANNULER",
		"SALIR": "QUITTER",
		"Los niveles normales son gratis. Solo los Boss Maze requieren pago y la campaña debe completarse estrictamente en orden.": "Les niveaux normaux sont gratuits. Seuls les Boss Maze sont payants, et la campagne doit être terminée strictement dans l’ordre.",
		"PROGRESO SECUENCIAL": "PROGRESSION SÉQUENTIELLE",
		"COMPLETADO": "TERMINÉ",
		"DISPONIBLE": "DISPONIBLE",
		"EN SECUENCIA": "DANS L’ORDRE",
		"Acceso permanente a este Boss Maze. Debés llegar completando la campaña en orden.": "Accès permanent à ce Boss Maze. Vous devez l’atteindre en terminant la campagne dans l’ordre.",
		"CAMPAÑA SECUENCIAL": "CAMPAGNE SÉQUENTIELLE",
		"Los niveles normales son gratis. Debés completar cada nivel en orden; solo los Boss Maze requieren pago.": "Les niveaux normaux sont gratuits. Vous devez terminer chaque niveau dans l’ordre ; seuls les Boss Maze sont payants.",
		"Los pagos compran acceso a Boss Maze y cosméticos permanentes. No venden soluciones ni ventajas competitivas.": "Les paiements achètent l’accès aux Boss Maze et des cosmétiques permanents. Ils ne vendent ni solutions ni avantages compétitifs.",
	},
	"de": {
		...
		"CANCELAR": "ABBRECHEN",
		"SALIR": "BEENDEN",
		"Los niveles normales son gratis. Solo los Boss Maze requieren pago y la campaña debe completarse estrictamente en orden.": "Normale Level sind kostenlos. Nur Boss Mazes sind kostenpflichtig, und die Kampagne muss strikt der Reihe nach abgeschlossen werden.",
		"PROGRESO SECUENCIAL": "SEQUENZIELLER FORTSCHRITT",
		"COMPLETADO": "ABGESCHLOSSEN",
		"DISPONIBLE": "VERFÜGBAR",
		"EN SECUENCIA": "DER REIHE NACH",
		"Acceso permanente a este Boss Maze. Debés llegar completando la campaña en orden.": "Dauerhafter Zugang zu diesem Boss Maze. Du musst es erreichen, indem du die Kampagne der Reihe nach abschließt.",
		"CAMPAÑA SECUENCIAL": "SEQUENZIELLE KAMPAGNE",
		"Los niveles normales son gratis. Debés completar cada nivel en orden; solo los Boss Maze requieren pago.": "Normale Level sind kostenlos. Du musst jedes Level der Reihe nach abschließen; nur Boss Mazes sind kostenpflichtig.",
		"Los pagos compran acceso a Boss Maze y cosméticos permanentes. No venden soluciones ni ventajas competitivas.": "Zahlungen kaufen Zugang zu Boss Mazes und dauerhafte Kosmetik. Sie verkaufen keine Lösungen oder Wettbewerbsvorteile.",
	},
	"it": {
		...
		"CANCELAR": "ANNULLA",
		"SALIR": "ESCI",
		"Los niveles normales son gratis. Solo los Boss Maze requieren pago y la campaña debe completarse estrictamente en orden.": "I livelli normali sono gratuiti. Solo i Boss Maze richiedono un pagamento e la campagna deve essere completata rigorosamente in ordine.",
		"PROGRESO SECUENCIAL": "PROGRESSO SEQUENZIALE",
		"COMPLETADO": "COMPLETATO",
		"DISPONIBLE": "DISPONIBILE",
		"EN SECUENCIA": "IN SEQUENZA",
		"Acceso permanente a este Boss Maze. Debés llegar completando la campaña en orden.": "Accesso permanente a questo Boss Maze. Devi raggiungerlo completando la campagna in ordine.",
		"CAMPAÑA SECUENCIAL": "CAMPAGNA SEQUENZIALE",
		"Los niveles normales son gratis. Debés completar cada nivel en orden; solo los Boss Maze requieren pago.": "I livelli normali sono gratuiti. Devi completare ogni livello in ordine; solo i Boss Maze richiedono un pagamento.",
		"Los pagos compran acceso a Boss Maze y cosméticos permanentes. No venden soluciones ni ventajas competitivas.": "I pagamenti acquistano l’accesso ai Boss Maze e cosmetici permanenti. Non vendono soluzioni né vantaggi competitivi.",
	},
}
